...
export const accountTitleValidation = Yup.string()
  .required("Account Title required");
...
export const transferFromAccountValidation = Yup.string()
  .required("Transfer from account required");
export const transferMemoValidation = Yup.string()
  .matches(alphanumericRegExp, "Must be letters and numbers only")
  .max(32, "Must be less than 32 characters");
export const transferToAccountValidation = Yup.string()
  .required("Transfer to account required");
export const wireExternalAccountNameValidation = Yup.string()
...
export const wireExternalFinancialInstitutionValidation = Yup.string()
...
export const wireIntermediaryBankNameValidation = Yup.string().when("useIntermediaryAccount", {
  is: (val: boolean) => val === true,
  then: (schema) => schema.required("Intermediary bank name is required"),
  otherwise: (schema) => schema,
});
export const wireIntermediaryRoutingNumberValidation = Yup.string().when("useIntermediaryAccount", {
  is: (val: boolean) => val === true,
  then: (schema) => schema
    .length(9, "Must be 9 characters in length")
    .matches(numberRegExp, "Must contain only numbers")
...
export const wireMemoValidation = Yup.string()
  .matches(alphanumericRegExp, "Must be letters and numbers only")
  .max(32, "Must be less than 32 characters");
export const wireReceivingAccountValidation = Yup.string()
  .required("Receiving account required");
export const wireSendingAccountValidation = Yup.string()
  .required("Sending account required");
